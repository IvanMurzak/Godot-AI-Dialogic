...
namespace com.IvanMurzak.Godot.MCP.Dialogic
{
    public partial class Tool_Dialogic
    {
        ...
        public const string EditorInfoToolId = "dialogic-editor-info";
        ...
        /// dialogic-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "Dialogic Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the Dialogic Tools extension. Returns the running " +
