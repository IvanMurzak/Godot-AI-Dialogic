...
namespace com.IvanMurzak.Godot.MCP.Dialogic.Tests
{
    ...
    /// PURE-MANAGED sample tool <c>dialogic-echo</c> by constructing the tool family and
    ...
    /// </summary>
    public class Tool_Dialogic_EchoTests
    {
        [Fact]
        ...
        {
            var tool = new Tool_Dialogic();
            Assert.Equal("dialogic-ready", tool.Echo(message));
        }
        ...
        public void EchoToolId_IsStable()
        {
            ...
            Assert.Equal("dialogic-echo", Tool_Dialogic.EchoToolId);
        }
    }
}
